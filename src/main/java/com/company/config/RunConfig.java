...
@EnableWebMvc
@Import({JpaDataSourceConfig.class, JpaConfig.class, JerseyRestConfig.class, WebMvcConfig.class, RestMvcConfig.class, MethodSecurityConfig.class, WebSecurityConfig.class, SwaggerConfig.class})
